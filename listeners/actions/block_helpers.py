...
def assemble_pr_message_blocks(client: WebClient, pr: dict, user_id: str) -> list:
    blocks = create_pr_message_block(client, pr)
...
def create_pr_message_block(client: WebClient, pr: dict) -> list:
